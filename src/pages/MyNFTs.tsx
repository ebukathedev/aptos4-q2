...
const MyNFTs: React.FC = () => {
	...
	const marketplaceAddr =
		"0x2ce1daa7c4b5ed5b24653c29973335d66b3eba870f6e1e804e68dda6735143de";
						...
						try {
							...
							return {
								...
								name: new TextDecoder().decode(
									hexToUint8Array(name.slice(2))
								),
								description: new TextDecoder().decode(
									hexToUint8Array(description.slice(2))
								),
								uri: new TextDecoder().decode(
									hexToUint8Array(uri.slice(2))
								),
								rarity,
							...
							console.error(
								`Error fetching details for NFT ID ${id}:`,
								error
							);
							return null;
						}
			...
			>
				{selectedNft && (
					<>
						...
						<p>
							<strong>Current Price:</strong> {selectedNft.price}{" "}
							APT
						</p>
